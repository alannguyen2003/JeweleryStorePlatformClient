export const HomePage = () => {
    return (
        <header className="header-main_area">
            ...
            <div className="header-middle_area d-none d-lg-block">
                <div className="container">
                    <div className="row">
            ...
            <div className="header-bottom_area header-sticky stick">
                <div className="container">
                    <div className="row">
                        <div className="col-md-4 col-sm-4 d-lg-none d-block">
                            <div className="header-logo">
                                <a href="index.html">
                        ...
                        <div className="col-lg-9 d-none d-lg-block position-static">
                        ...
                        <ul className="minicart-list">
                            <li className="minicart-product">
                                ...
                                <div className="product-item_content">
                                    <a className="product-item_title" href="shop-left-sidebar.html">Magni dolorum vel</a>
                            ...
                            <li className="minicart-product">
                                ...
                                <div className="product-item_content">
                                    <a className="product-item_title" href="shop-left-sidebar.html">Eius accusantium omnis</a>
                                    <span className="product-item_quantity">1 x $120.80</span>
                                </div>
                            </li>
                            <li className="minicart-product">
                                ...
                                <div className="product-item_content">
                                    <a className="product-item_title" href="shop-left-sidebar.html">Aperiam adipisci dolorem</a>
                                    <span className="product-item_quantity">1 x $120.80</span>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div className="container">
                        ...
                        <nav className="offcanvas-navigation">
                            <ul className="mobile-menu">
                                <li className="menu-item-has-children active"><a href="#"><span className="mm-text">Home</span></a>
                                    ...
                                    <ul className="sub-menu">
                                        ...
                                        <li>
                                            <a href="coming-soon_page.html">
                                                <span className="mm-text">Comming Soon</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <nav className="offcanvas-navigation user-setting_area">
                            <ul className="mobile-menu">
                                ...
                                <li className="menu-item-has-children"><a href="#"><span className="mm-text">Currency</span></a>
                                    <ul className="sub-menu">
                                        <li>
                                ...
                                <li className="menu-item-has-children"><a href="#"><span className="mm-text">Language</span></a>
                                    <ul className="sub-menu">
                                        <li>
                                            <a href="javascript:void(0)">
