            ...
            <div className="container">
                <div className="main__header--inner d-flex justify-content-between align-items-center">
                    ...
                    <div className="main__logo">
                        <h1 className="main__logo--title"><a className="main__logo--link" href="index-2.html">
                        ...
                        <nav className="header__menu--navigation">
                            <ul className="header__menu--wrapper d-flex">
                                <li className="header__menu--items">
                                    <a className="header__menu--link active" href="index-2.html">Home 
                                    ...
                                    <ul className="header__sub--menu">
                                        <li className="header__sub--menu__items"><a href="index-2.html" className="header__sub--menu__link">Home - Beauty Cosmetic</a></li>
                                        <li className="header__sub--menu__items"><a href="index-3.html" className="header__sub--menu__link">Home - Cosmetic Spa</a></li>
                                        <li className="header__sub--menu__items"><a href="index-4.html" className="header__sub--menu__link">Home - Jewelry Store</a></li>
                                        <li className="header__sub--menu__items"><a href="index-5.html" className="header__sub--menu__link">Home -  Modern Jewelry</a></li>
                                        <li className="header__sub--menu__items"><a href="index-6.html" className="header__sub--menu__link">Home - Look book</a></li>
                                        <li className="header__sub--menu__items"><a href="index-7.html" className="header__sub--menu__link">Home - Beauty Jewelers</a></li>
                                        <li className="header__sub--menu__items"><a href="index-8.html" className="header__sub--menu__link">Home - Parallax</a></li>
                                    </ul>
                                </li>
        ...
        <div className="offcanvas__header">
            <div className="offcanvas__inner">
                <div className="offcanvas__logo">
                    <a className="offcanvas__logo_link" href="index-2.html">
                ...
                <nav className="offcanvas__menu">
                    <ul className="offcanvas__menu_ul">
                        <li className="offcanvas__menu_li">
                            <a className="offcanvas__menu_item" href="index-2.html">Home</a>
                            <ul className="offcanvas__sub_menu">
                                <li className="offcanvas__sub_menu_li"><a href="index-2.html" className="offcanvas__sub_menu_item">Home - Beauty Cosmetic</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-3.html" className="offcanvas__sub_menu_item">Home - Cosmetic Spa</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-4.html" className="offcanvas__sub_menu_item">Home - Jewelry Store</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-5.html" className="offcanvas__sub_menu_item">Home - Modern Jewelry</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-6.html" className="offcanvas__sub_menu_item">Home - Look book</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-7.html" className="offcanvas__sub_menu_item">Home - Beauty Jewelers</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-8.html" className="offcanvas__sub_menu_item">Home - Parallax</a></li>
                            </ul>
                        </li>
                        <li className="offcanvas__menu_li">
        ...
        <div className="offcanvas__sticky--toolbar">
            <ul className="d-flex justify-content-between">
                <li className="offcanvas__sticky--toolbar__list">
                    <a className="offcanvas__sticky--toolbar__btn" href="index-2.html">
