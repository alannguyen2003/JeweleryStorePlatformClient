            ...
            <div className="main__logo">
              <h1 className="main__logo--title">
                <a className="main__logo--link" href="/">
                  <img className="main__logo--img" src={logo} alt="logo-img" />
                </a>
              </h1>
            </div>
                ...
                <ul className="header__account--wrapper d-flex align-items-center">
                  ...
                  <li className="header__account--items header__minicart--items">
                    ...
                    >
                      ...
                      <span className="items__count">{getItemCount()}</span>
                    </a>
                  </li>
                </ul>
              ) : (
                <div>
                  <span className="header-login-signup">
                    <a href="/authentication">Đăng Nhập</a>
                  </span>
                  {"\t"}
                  <span>/</span>
                  {"\t"}
                  <span className="header-login-signup">
                    <a href="/authentication">Đăng Ký</a>
                  </span>
                </div>
              )}
            </div>
