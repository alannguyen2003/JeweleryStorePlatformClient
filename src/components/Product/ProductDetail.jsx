import payment from "../../assets/img/other/safe-checkout.webp"
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product/product1.webp">
                                            <img class="product__media--preview__items--img" src="assets/img/product/big-product/product1.webp" alt="product-media-img"/>
                                        </a>
                    ...
                    <div class="product__details--info">
                        <form action="#">
                            ...
                            <div class="guarantee__safe--checkout mb-30">
                                ...
                                <img class="guarantee__safe--checkout__img" src={payment} alt="Payment Image"/>
                            </div>
                        </form>
                    </div>
                </div>  
