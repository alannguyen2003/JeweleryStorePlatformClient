...
export const ProductContent = ({ diamondList }) => {
      ...
      <div className="shop__product--wrapper position__sticky">
        <div className="shop__header d-flex align-items-center justify-content-between mb-30">
          ...
          <p className="product__showing--count">
            Showing 1–{diamondList.length} of {diamondList.length} results
          </p>
        </div>
            ...
            <div className="product__section--inner">
              <div className="row mb--n30">
                {diamondList.map((diamond, index) => {
                  return <ProductCard key={index} diamond={diamond} />;
                })}
              </div>
            </div>
          </div>
                  ...
                  <div className="product__card product__list d-flex align-items-center">
                    ...
                    <div className="product__card--content product__list--content">
                      ...
                      <p className="product__card--content__desc mb-15">
                        ...
                        corporis deleniti officia culpa dolor esse there.
                      </p>
                      <a
        ...
        <div class="pagination__area">
          <nav class="pagination justify-content-center">
            <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
              ...
              <li class="pagination__list">
                <a href="/shop" class="pagination__item link">
                  2
                </a>
              </li>
              <li class="pagination__list">
