...
export const ProductCard = ({ diamond }) => {
  ...
  return (
    <div className="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
      <Link to={`/product/${diamond.id}`}></Link>
      <article className="product__card">
        <div className="product__card--thumbnail">
          ...
          <div className="product__add--to__card add-cart-button">
            <button
              className="product__card--btn add-cart-button"
              title="Add To Cart"
              onClick={() => navigate(`/product/${diamond.id}`)}
            >
              {" "}
              Add to Cart
              <svg
        ...
        <div className="product__card--content text-center">
          ...
          <div className="product__card--price">
            <span className="current__price">{formatToVND(diamond.price)}</span>
          </div>
        </div>
      </article>
    </div>
